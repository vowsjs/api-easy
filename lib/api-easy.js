...
exports.describe = function (text) {
  return {
    ...
    uploadFile: function (/* [uri, filepath] */) {
      var args = Array.prototype.slice.call(arguments);
      var filepath = args.splice(1,1);
    ...
    vows : function() {
      ...
      // injects `easy` method into vows object to be able 
      // to switch back to APIEasy 
      if(typeof this.suite.easy == "undefined") {
        var _self = this;
        this.suite.easy = function() {
          return _self;
        }
      }
      return this.suite;
